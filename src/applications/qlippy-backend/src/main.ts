...
import {clipboardHandleExport} from "./clipboard/handle-export";
import {clipboardHandleImport} from "./clipboard/handle-import";
...
if (!isSingleInstance) {
    ...
    const onReady = async () => {
        ...
        await clipboardHandleExport.initialize();
        await clipboardHandleImport.initialize();
